 ...
 */
@Data
@ConfigurationProperties(AuthUpdateConfig.AUTH_UPDATE_CONFIG)
public class AuthUpdateConfig {

    public static final String AUTH_UPDATE_CONFIG = "garble.auth.update";

    public Map<String, Object> getPropertiesMap() {
        return BeanMapUtil.beanToMap(this, AuthUpdateConfig.class);
    }
